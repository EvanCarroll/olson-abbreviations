# This Makefile is for the Olson::Abbreviations extension to perl.
#
...
#     AUTHOR => q[Evan Carroll <me+cpan@evancarroll.com>]
#     DIR => []
#     DISTNAME => q[Olson-Abbreviations]
#     NAME => q[Olson::Abbreviations]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], MooseX::AttributeHelpers=>q[0], ExtUtils::MakeMaker=>q[6.42], MooseX::ClassAttribute=>q[0], Moose=>q[0] }
#     VERSION => q[0.01]
#     dist => { PREOP=>q[$(PERL) -I. "-MModule::Install::Admin" -e "dist_preop(q($(DISTVNAME)))"] }
#     realclean => { FILES=>q[MYMETA.yml] }
#     test => { TESTS=>q[t/00-load.t t/01-test.t t/boilerplate.t t/pod-coverage.t t/pod.t] }
...
MAKE = make
FULLEXT = Olson/Abbreviations
BASEEXT = Abbreviations
PARENT_NAME = Olson
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Olson/Abbreviations.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Olson
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Olson
...
TO_INST_PM = lib/Olson/Abbreviations.pm

PM_TO_BLIB = lib/Olson/Abbreviations.pm \
...
DISTNAME = Olson-Abbreviations
DISTVNAME = Olson-Abbreviations-0.01
...
manifypods : pure_all  \
	lib/Olson/Abbreviations.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Olson/Abbreviations.pm $(INST_MAN3DIR)/Olson::Abbreviations.$(MAN3EXT) 
...
TEST_FILE = test.pl
TEST_FILES = t/00-load.t t/01-test.t t/boilerplate.t t/pod-coverage.t t/pod.t
TESTDB_SW = -d
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Evan Carroll &lt;me+cpan@evancarroll.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="MooseX-AttributeHelpers" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Olson/Abbreviations.pm blib/lib/Olson/Abbreviations.pm 
